...
__IMPORTS__.env._Znwm=function(a)return MALLOC(a)end
__IMPORTS__.env._Znwj=function(a)return MALLOC(a)end
__IMPORTS__.env._Znam=function(a)return MALLOC(a)end
__IMPORTS__.env._Znaj=function(a)return MALLOC(a)end