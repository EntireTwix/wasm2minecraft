...
__IMPORTS__.env._Znwm=function(a)__MALLOC__(a)end
__IMPORTS__.env._Znwj=function(a)__MALLOC__(a)end
__IMPORTS__.env._Znam=function(a)__MALLOC__(a)end
__IMPORTS__.env._Znaj=function(a)__MALLOC__(a)end
