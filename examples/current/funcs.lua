...
do
    local mem_0 = __MEMORY_ALLOC__(1);
    module.memory = mem_0
    function __FUNCS__.func_3()
        do return 1; end;
    end
    function __FUNCS__.func_4()
        do return 42; end;
    end
    function __FUNCS__.func_5()
        local reg0,reg1;
        reg0 = __IMPORTS__.env._Znwj(1);
        reg1 = reg0;
        __MEMORY_WRITE_8__(mem_0,reg1,0);
        do return reg1; end;
    end
    function __FUNCS__.func_6(reg0)
        local reg1;
        reg1 = __MEMORY_READ_8__(mem_0,reg0);
        __MEMORY_WRITE_8__(mem_0,reg0,(bit_bxor(reg1,1)));
    end
    function __FUNCS__.func_7(reg0)
        local reg1;
        reg1 = __MEMORY_READ_8__(mem_0,reg0);
        do return reg1; end;
    end
    function __FUNCS__.func_8(reg0)
        
            if ((reg0 == 0) and 1 or 0)~=0 then goto block_1_fin; end;
            __IMPORTS__.env._ZdlPv(reg0);
        ::block_1_fin::
    end
    function __FUNCS__.func_9()
        __IMPORTS__.env._webidl_main_yield();
        do return 0; end;
    end
    __EXPORTS__["memory"] = mem_0;
    __EXPORTS__["True"] = __FUNCS__.func_3;
    __EXPORTS__["_webidl_lua_global_Answer"] = __FUNCS__.func_4;
    __EXPORTS__["_webidl_lua_Example_Example"] = __FUNCS__.func_5;
    __EXPORTS__["_webidl_lua_Example_Toggle"] = __FUNCS__.func_6;
    __EXPORTS__["_webidl_lua_Example_Get"] = __FUNCS__.func_7;
    __EXPORTS__["_webidl_lua_Example__delete_void"] = __FUNCS__.func_8;
    __EXPORTS__["main"] = __FUNCS__.func_9;
    ...
    function module.init()
        ...
        __IMPORTS__.env._Znwm=function(a)return __MALLOC__(a)end
        __IMPORTS__.env._Znwj=function(a)return __MALLOC__(a)end
        __IMPORTS__.env._Znam=function(a)return __MALLOC__(a)end
        __IMPORTS__.env._Znaj=function(a)return __MALLOC__(a)end
    end
end
...
do
    local __CFUNCS__ = {}
    __IMPORTS__.webidl_cfuncs = __CFUNCS__
    __BINDINGS__.global = __BINDER__.createNamespace()
        function __BINDINGS__.global.Answer()local ret = __EXPORTS__._webidl_lua_global_Answer()return ret end
    
    __BINDINGS__.Example = {} __BINDER__.createClass(__BINDINGS__.Example,"Example")
    setmetatable(__BINDINGS__.Example,{__call = function(self)local ins = __BINDER__.instantiateClass(__BINDINGS__.Example,0,true)ins:Example()return ins end})
        function __BINDINGS__.Example:Example()self.__ptr = __EXPORTS__._webidl_lua_Example_Example();__BINDINGS__.Example.__cache[self.__ptr] = self; end
        function __BINDINGS__.Example:Toggle()local ret = __EXPORTS__._webidl_lua_Example_Toggle(self.__ptr);return ret end
        function __BINDINGS__.Example:Get()local ret = __EXPORTS__._webidl_lua_Example_Get(self.__ptr);return ret ~= 0 end
        function __BINDINGS__.Example:_delete()return __EXPORTS__._webidl_lua_Example__delete_void(self.__ptr)end
    
    __IMPORTS__.webidl_internal = {main_yield = coroutine.yield}
    module.init = coroutine.wrap(module.init)
end
